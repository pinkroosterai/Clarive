...
{
    public AiGenerationTests(IntegrationTestFixture fixture) : base(fixture) { }
    ...
    public async Task Generate_AsEditor_ReturnsSessionWithDraft()
    {
        ...
        body.GetProperty("draft").GetProperty("title").GetString()
            .Should().Contain("Write a product review");
        body.GetProperty("draft").GetProperty("systemMessage").GetString()
        ...
        body.GetProperty("evaluation").GetProperty("dimensions").EnumerateObject()
    ...
    public async Task Generate_WithTemplateFlag_ReturnsTemplatePrompt()
    {
        ...
        var (response, body) = await Client.PostJsonAsync<JsonElement>("/api/ai/generate", new
        {
            description = "Write formal emails",
    ...
    public async Task Refine_WithValidSession_ReturnsRefinedDraft()
    {
        ...
        var (_, generateBody) = await Client.PostJsonAsync<JsonElement>("/api/ai/generate", new
        {
        ...
        // Now refine
        var (response, body) = await Client.PostJsonAsync<JsonElement>("/api/ai/refine", new
        {
            sessionId,
    ...
    public async Task Refine_InvalidSession_Returns404()
    {
        ...
        var response = await Client.PostAsJsonAsync("/api/ai/refine", new
        {
    ...
    public async Task Refine_OutOfBoundsEnhancementIndices_IgnoresInvalid()
    {
        ...
        {
            sessionId,
            selectedEnhancements = new[] { -1, 999 }
        });
    ...
    public async Task Enhance_ValidEntry_ReturnsEnhancedDraft()
    {
        ...
        var (response, body) = await Client.PostJsonAsync<JsonElement>("/api/ai/enhance", new
        {
            entryId = TestData.EntryBlogPostGenerator
        });
    ...
    public async Task Enhance_InvalidEntry_Returns404()
    {
        ...
        var response = await Client.PostAsJsonAsync("/api/ai/enhance", new
        {
    ...
    public async Task GenerateSystemMessage_EntryWithoutSystemMessage_ReturnsMessage()
    {
        ...
        var (response, body) = await Client.PostJsonAsync<JsonElement>("/api/ai/generate-system-message", new
        {
            entryId = TestData.EntryMeetingNotes
        });
    ...
    public async Task GenerateSystemMessage_EntryAlreadyHasSystemMessage_Returns409()
    {
        ...
        var response = await Client.PostAsJsonAsync("/api/ai/generate-system-message", new
        {
            entryId = TestData.EntryBlogPostGenerator
        });
    ...
    public async Task Decompose_SinglePromptEntry_ReturnsChainSteps()
    {
        ...
        var (response, body) = await Client.PostJsonAsync<JsonElement>("/api/ai/decompose", new
        {
            entryId = TestData.EntryBlogPostGenerator
        });
    ...
    public async Task Decompose_MultiPromptEntry_Returns409()
    {
        ...
        var response = await Client.PostAsJsonAsync("/api/ai/decompose", new
        {
            entryId = TestData.EntryCodeReviewPipeline
        });
