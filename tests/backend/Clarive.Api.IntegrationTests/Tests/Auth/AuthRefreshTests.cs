...
{
    public AuthRefreshTests(IntegrationTestFixture fixture) : base(fixture) { }
    ...
    public async Task Refresh_WithValidToken_ReturnsNewTokenPair()
    {
        ...
        refreshJson.GetProperty("user").GetProperty("email").GetString()
            .Should().Be(TestData.AdminEmail);
    ...
    public async Task Refresh_WithInvalidToken_Returns401()
    {
        ...
        {
            refreshToken = "rt_invalid_token_that_does_not_exist"
        });
