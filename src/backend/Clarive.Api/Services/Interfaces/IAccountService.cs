...
public interface IAccountService
{
    ...
    /// </summary>
    Task<ErrorOr<RegisterResult>> RegisterAsync(string email, string name, string password, CancellationToken ct = default);
    ...
    /// </summary>
    Task<ErrorOr<GoogleAuthLoginResult>> LoginWithGoogleAsync(string idToken, string? nonce = null, CancellationToken ct = default);
    ...
    /// </summary>
    Task<ErrorOr<RefreshResult>> RefreshTokensAsync(string refreshToken, CancellationToken ct = default);
    ...
    /// </summary>
    Task<ErrorOr<InvitationAcceptResult>> AcceptInvitationAsync(string invitationToken, string name, string password, CancellationToken ct = default);
}
