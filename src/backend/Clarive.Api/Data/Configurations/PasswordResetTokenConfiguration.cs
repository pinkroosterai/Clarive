...
public class PasswordResetTokenConfiguration : IEntityTypeConfiguration<PasswordResetToken>
{
    public void Configure(EntityTypeBuilder<PasswordResetToken> builder)
    {
        ...
        builder.Property(pr => pr.TokenHash).HasColumnName("token_hash").HasMaxLength(128).IsRequired();
        ...
        builder.HasIndex(pr => pr.TokenHash).IsUnique().HasDatabaseName("uq_password_reset_token_hash");
