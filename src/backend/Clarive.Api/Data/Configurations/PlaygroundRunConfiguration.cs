...
public class PlaygroundRunConfiguration : IEntityTypeConfiguration<PlaygroundRun>
{
    public void Configure(EntityTypeBuilder<PlaygroundRun> builder)
    {
        ...
        builder.Property(r => r.TemplateFieldValues).HasColumnName("template_field_values")
            .HasColumnType("jsonb");
        builder.Property(r => r.Responses).HasColumnName("responses")
            .HasColumnType("jsonb")
            .IsRequired();
        builder.Property(r => r.Reasoning).HasColumnName("reasoning")
            .HasColumnType("jsonb");
        ...
        builder.HasIndex(r => new { r.TenantId, r.EntryId })
