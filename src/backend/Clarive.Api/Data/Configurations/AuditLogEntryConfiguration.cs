...
public class AuditLogEntryConfiguration : IEntityTypeConfiguration<AuditLogEntry>
{
    public void Configure(EntityTypeBuilder<AuditLogEntry> builder)
    {
        ...
        builder.Property(a => a.Action).HasColumnName("action").HasMaxLength(30)
        ...
        builder.Property(a => a.EntityTitle).HasColumnName("entity_title").HasMaxLength(500).IsRequired();
