...
public class AiUsageLogConfiguration : IEntityTypeConfiguration<AiUsageLog>
{
    public void Configure(EntityTypeBuilder<AiUsageLog> builder)
    {
        ...
        builder
            .Property(l => l.EstimatedInputCostUsd)
            .HasColumnName("estimated_input_cost_usd")
            .HasPrecision(18, 8);
        builder
            .Property(l => l.EstimatedOutputCostUsd)
        ...
        builder.HasIndex(l => l.UserId).HasDatabaseName("ix_ai_usage_logs_user_id");
        builder.HasIndex(l => l.Model).HasDatabaseName("ix_ai_usage_logs_model");
        builder.HasIndex(l => l.ActionType).HasDatabaseName("ix_ai_usage_logs_action_type");
    }
}
