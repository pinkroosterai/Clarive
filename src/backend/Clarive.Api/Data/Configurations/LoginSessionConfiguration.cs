...
public class LoginSessionConfiguration : IEntityTypeConfiguration<LoginSession>
{
    public void Configure(EntityTypeBuilder<LoginSession> builder)
    {
        ...
        builder.Property(ls => ls.IpAddress).HasColumnName("ip_address").HasMaxLength(45).IsRequired();
        builder.Property(ls => ls.UserAgent).HasColumnName("user_agent").HasMaxLength(512)
            .IsRequired().HasDefaultValue("");
        builder.Property(ls => ls.Browser).HasColumnName("browser").HasMaxLength(100)
            .IsRequired().HasDefaultValue("");
        builder.Property(ls => ls.Os).HasColumnName("os").HasMaxLength(100)
            .IsRequired().HasDefaultValue("");
        ...
        builder.HasIndex(ls => ls.RefreshTokenId).IsUnique()
