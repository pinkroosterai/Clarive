...
public class EmailVerificationTokenConfiguration : IEntityTypeConfiguration<EmailVerificationToken>
{
    public void Configure(EntityTypeBuilder<EmailVerificationToken> builder)
    {
        ...
        builder.Property(ev => ev.TokenHash).HasColumnName("token_hash").HasMaxLength(128).IsRequired();
        ...
        builder.HasIndex(ev => ev.TokenHash).IsUnique().HasDatabaseName("uq_email_verification_token_hash");
