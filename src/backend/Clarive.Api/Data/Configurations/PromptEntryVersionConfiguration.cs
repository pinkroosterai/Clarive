...
public class PromptEntryVersionConfiguration : IEntityTypeConfiguration<PromptEntryVersion>
{
    public void Configure(EntityTypeBuilder<PromptEntryVersion> builder)
    {
        ...
        builder.Property(v => v.VersionState).HasColumnName("version_state").HasMaxLength(20)
        ...
        builder.HasIndex(v => new { v.EntryId, v.VersionState }).HasDatabaseName("ix_prompt_entry_versions_entry_state");
        builder.HasIndex(v => new { v.EntryId, v.Version })
            .IsUnique()
