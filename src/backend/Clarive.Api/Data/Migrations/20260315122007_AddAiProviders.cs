...
namespace Clarive.Api.Data.Migrations
{
    ...
    public partial class AddAiProviders : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    endpoint_url = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_temperature_configurable = table.Column<bool>(
                        type: "boolean",
                        nullable: false
                    ),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
        ...
        {
            migrationBuilder.DropTable(name: "ai_provider_models");
