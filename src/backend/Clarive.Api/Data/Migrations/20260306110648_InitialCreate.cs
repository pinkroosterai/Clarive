...
namespace Clarive.Api.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_encrypted = table.Column<bool>(
                        type: "boolean",
                        nullable: false,
                        defaultValue: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    maintenance_enabled = table.Column<bool>(
                        type: "boolean",
                        nullable: false,
                        defaultValue: false
                    ),
                    maintenance_since = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    maintenance_by = table.Column<string>(
                        type: "character varying(255)",
                        maxLength: 255,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    agent_session_id = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    key_prefix = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    entity_title = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    version_state = table.Column<string>(
                        type: "character varying(20)",
                        maxLength: 20,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    delete_scheduled_at = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    avatar_path = table.Column<string>(
                        type: "character varying(512)",
                        maxLength: 512,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    email_verified = table.Column<bool>(
                        type: "boolean",
                        nullable: false,
                        defaultValue: false
                    ),
                    ...
                    onboarding_completed = table.Column<bool>(
                        type: "boolean",
                        nullable: false,
                        defaultValue: false
                    ),
                    ...
                    is_super_user = table.Column<bool>(
                        type: "boolean",
                        nullable: false,
                        defaultValue: false
                    ),
                    theme_preference = table.Column<string>(
        ...
        {
            migrationBuilder.DropForeignKey(name: "FK_users_tenants_tenant_id", table: "users");

            migrationBuilder.DropTable(name: "ai_sessions");
            ...
            migrationBuilder.DropTable(name: "service_config");

            migrationBuilder.DropTable(name: "system_config");

            migrationBuilder.DropTable(name: "template_fields");

            migrationBuilder.DropTable(name: "tenant_memberships");

            migrationBuilder.DropTable(name: "tool_descriptions");

            migrationBuilder.DropTable(name: "refresh_tokens");

            migrationBuilder.DropTable(name: "prompts");

            migrationBuilder.DropTable(name: "prompt_entry_versions");

            migrationBuilder.DropTable(name: "prompt_entries");
