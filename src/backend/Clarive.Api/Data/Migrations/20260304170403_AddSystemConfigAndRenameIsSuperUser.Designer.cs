...
namespace Clarive.Api.Data.Migrations
{
    ...
    [Migration("20260304170403_AddSystemConfigAndRenameIsSuperUser")]
    partial class AddSystemConfigAndRenameIsSuperUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clarive.Api.Models.Entities.CreditBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("FreeCredits")
                        ...
                        .HasColumnName("free_credits");

                    b.Property<DateTime>("LastFreeReplenishAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_free_replenish_at");

                    b.Property<int>("PurchasedCredits")
                        .HasColumnType("integer")
                        .HasColumnName("purchased_credits");
                    ...
                    b.HasIndex("TenantId")
                        .IsUnique()
                        .HasDatabaseName("uq_credit_balances_tenant_id");

                    b.ToTable("credit_balances", (string)null);
                });

            modelBuilder.Entity("Clarive.Api.Models.Entities.CreditTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ReferenceId")
                        .HasDatabaseName("ix_credit_transactions_reference")
                        .HasFilter("reference_id IS NOT NULL");

                    b.HasIndex("TenantId", "CreatedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("ix_credit_transactions_tenant_created");
            ...
            modelBuilder.Entity("Clarive.Api.Models.Entities.Tenant", b =>
                {
                    ...
                    b.HasIndex("StripeCustomerId")
                        .IsUnique()
                        .HasDatabaseName("uq_tenants_stripe_customer_id")
