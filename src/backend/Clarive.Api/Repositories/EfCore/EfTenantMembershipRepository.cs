...
{
    public async Task<List<TenantMembership>> GetByUserIdAsync(
        Guid userId,
    ...
    public async Task<TenantMembership?> GetAsync(
        Guid userId,
        Guid tenantId,
        CancellationToken ct = default
    )
    ...
    public async Task<List<TenantMembership>> GetByTenantIdAsync(
        Guid tenantId,
        CancellationToken ct = default
    )
    {
    ...
    public async Task<TenantMembership> CreateAsync(
    ...
    public async Task<Dictionary<Guid, int>> CountMembersByTenantIdsAsync(
