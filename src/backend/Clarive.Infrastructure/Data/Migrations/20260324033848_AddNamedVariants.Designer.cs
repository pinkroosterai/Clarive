...
namespace Clarive.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260324033848_AddNamedVariants")]
    partial class AddNamedVariants
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clarive.Domain.Entities.ABTestRun", b =>
                {
                    ...
                    b.Property<string>("VersionALabel")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("version_a_label");

                    b.Property<Guid?>("VersionBId")
                        .HasColumnType("uuid")
                        .HasColumnName("version_b_id");

                    b.Property<string>("VersionBLabel")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("version_b_label");
                    ...
                    b.HasIndex("VersionAId");

                    b.HasIndex("VersionBId");
            ...
            modelBuilder.Entity("Clarive.Domain.Entities.AiProviderModel", b =>
                {
                    ...
                    b.Property<bool>("SupportsResponseSchema")
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("Clarive.Domain.Entities.JobExecutionHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Clarive.Domain.Entities.McpServer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("BearerTokenEncrypted")
                        .HasColumnType("text")
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_mcp_servers_tenant_id");

                    b.HasIndex("IsActive", "NextSyncAt")
            ...
            modelBuilder.Entity("Clarive.Domain.Entities.PromptEntryVersion", b =>
                {
                    ...
                    b.Property<double?>("EvaluationAverageScore")
                        .HasColumnType("double precision")
                    ...
                    b.HasIndex("EntryId", "VariantName")
                        .IsUnique()
            ...
            modelBuilder.Entity("Clarive.Domain.Entities.ShareLink", b =>
                {
                    ...
                    b.HasIndex("TokenHash")
                        .IsUnique()
                        .HasDatabaseName("uq_share_links_token_hash");
            ...
            modelBuilder.Entity("Clarive.Domain.Entities.ToolDescription", b =>
                {
                    ...
                    b.HasIndex("McpServerId")
                        .HasDatabaseName("ix_tool_descriptions_mcp_server_id");
            ...
            modelBuilder.Entity("Clarive.Domain.Entities.ABTestRun", b =>
                {
                    ...
                    b.HasOne("Clarive.Domain.Entities.PromptEntryVersion", null)
                        .WithMany()
                        .HasForeignKey("VersionAId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Clarive.Domain.Entities.PromptEntryVersion", null)
                        .WithMany()
                        .HasForeignKey("VersionBId")
                        .OnDelete(DeleteBehavior.SetNull);
