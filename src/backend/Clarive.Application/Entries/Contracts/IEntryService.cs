...
public interface IEntryService
{
    ...
    Task<ErrorOr<(List<PromptEntryDto> Summaries, int TotalCount)>> ListEntriesAsync(
        Guid tenantId,
        Guid userId,
        Guid? folderId,
        bool includeAll,
    ...
    Task<ErrorOr<(List<PromptEntryDto> Summaries, int TotalCount)>> ListTrashedEntriesAsync(
        Guid tenantId,
        Guid userId,
        int page,
        int pageSize,
