...
test.describe('Onboarding — Tour Flow', () => {
  ...
  test('new user sees the onboarding tour tooltip on first login', async ({ page }) => {
  ...
  test('tour can be progressed through all 4 steps with Next button', async ({ page }) => {
    await registerNewUser(page);
  ...
  test('tour does not reappear after page reload once completed', async ({ page }) => {
    await registerNewUser(page);
...
test.describe('Onboarding — Starter Templates', () => {
  ...
  test("new user gets a 'Getting Started' folder with starter entries", async ({ page }) => {
    await registerNewUser(page);
...
test.describe('Onboarding — Existing Users', () => {
  test('existing admin user does not see the onboarding tour', async ({ browser }) => {
