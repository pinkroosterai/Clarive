...
const TAB_STYLE = "gap-1.5 min-h-[44px] text-foreground-muted hover:text-foreground-secondary data-[state=active]:bg-surface data-[state=active]:elevation-1 data-[state=active]:rounded-md data-[state=active]:text-foreground";
...
const SettingsPage = () => {
  ...
  useEffect(() => { document.title = "Clarive — Settings"; }, []);
