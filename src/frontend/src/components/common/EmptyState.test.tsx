...
describe('EmptyState', () => {
  ...
  it('renders the icon', () => {
    const { container } = render(
      <EmptyState icon={Folder} title="Empty folder" description="This folder has no items." />
    );
  ...
  it('renders without actions when not provided', () => {
    render(<EmptyState icon={FileText} title="No prompts" description="Nothing here." />);
