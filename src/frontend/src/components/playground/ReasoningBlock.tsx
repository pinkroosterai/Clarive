...
export default function ReasoningBlock({
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      ...
      <CollapsibleContent>
        <div
          className={`rounded-lg border border-indigo-200 dark:border-indigo-800 bg-indigo-50 dark:bg-indigo-950/20 p-3 mb-3 ${isStreaming ? 'max-h-96' : 'max-h-64'} overflow-y-auto scrollbar-themed`}
        >
